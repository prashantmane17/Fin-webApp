...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-background to-muted/20">
      {/* Navigation */}
      <nav className="px-2 sticky top-0 z-50 border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
          ...
          {[
            {
              ...
              description:
                "Bank-grade security for all your transactions and member data",
            ...
            },
            {
              ...
              description:
                "Efficiently manage members, payments, and documentation",
            ...
            >
              <div
                className={`p-3 rounded-full w-12 h-12 flex items-center justify-center bg-gradient-to-r ${feature.iconGradient} mb-4`}
              >
      ...
      <section className="container mx-auto py-16 space-y-8">
        <div className="text-center space-y-4">
          ...
          <p className="text-muted-foreground max-w-[600px] mx-auto">
            Join thousands of satisfied customers who trust us with their chit
            fund management
          </p>
        </div>
